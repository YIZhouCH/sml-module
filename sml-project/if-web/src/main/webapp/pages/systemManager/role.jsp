...
<script type="text/javascript">
    ...
    $(function() {
        roleDataGrid = $('#roleDataGrid').datagrid({
            url : smlManager.getQryUrl('system-role-qry?NOWRAPPER=true'),
            striped : true,
            rownumbers : true,
            pagination : true,
            singleSelect : true,
            ...
            queryParams:{
            	start:function(){
            		var limit=$('#roleDataGrid').datagrid("getPager").pagination("options").pageSize;
            		var page=$('#roleDataGrid').datagrid("getPager").pagination("options").pageNumber;
            		return (page-1)*limit;
            	}
            },
            frozenColumns : [ [ {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                    	<shiro:hasPermission name="/pages/systemManager/roleGrant.jsp">
                        ...
                        <shiro:hasPermission name="/pages/systemManager/roleEdit.jsp">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                        ...
                        <shiro:hasPermission name="/sml/update/system-role-up/delete">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    ...
    function editRoleFun(id) {
    	roleDataGrid.datagrid('selectRecord',id);
    ...
    function deleteRoleFun(id) {
        ...
        parent.$.messager.confirm('询问', '您是否要删除当前角色？', function(b) {
            if (b) {
            	  progressLoad();
                  smlManager.update('system-role-up',{id:id,upType:'delete'},function(result){
                          if (result.success) {
...
<div id="roleToolbar" style="display: none;">
	<shiro:hasPermission name="/pages/systemManager/roleAdd.jsp">
