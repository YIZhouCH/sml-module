...
<script type="text/javascript">
    $(function() {
    	...
    	var formLst=$.stringToList('id,name,description@textarea,seq,status@select');
        ...
        $('#roleEditForm').form({
            url :smlManager.getUpUrl('system-role-up','update'),
            onSubmit : function() {
                progressLoad();
        ...
        <input name="upType" type="hidden"  value="update" >
            <table class="grid">
                <tr>
                    ...
                    <input name="name" type="text" placeholder="请输入角色名称" class="easyui-validatebox" data-options="required:true"></td>
                </tr>
                <tr>
                    <td>排序</td>
