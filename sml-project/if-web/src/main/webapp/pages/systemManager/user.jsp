...
<script type="text/javascript">
    ...
    $(function() {
        ...
        userDataGrid = $('#userDataGrid').datagrid({
            url : smlManager.getQryUrl('system-user-qry?NOWRAPPER=true'),
            fit : true,
            striped : true,
            rownumbers : false,
            pagination : true,
            ...
            queryParams:{
            	start:function(){
            		var limit=$('#userDataGrid').datagrid("getPager").pagination("options").pageSize;
            		var page=$('#userDataGrid').datagrid("getPager").pagination("options").pageNumber;
            		return (page-1)*limit;
            	}
            },
            columns : [ [ {
            ...
            }, 
            {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                    	<shiro:hasPermission name="/pages/systemManager/userEdit.jsp">
						...
						<shiro:hasPermission name="/sml/update/system-user-up/delete">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
    ...
    function deleteUserFun(id) {
        ...
        parent.$.messager.confirm('询问', '您是否要删除当前用户？', function(b) {
            if (b) {
                progressLoad();
                smlManager.update('system-user-up/delete',{id:id,upType:'delete'},function(result){
                    if (result.success) {
    ...
    function editUserFun(id) {
    	userDataGrid.datagrid('selectRecord',id);
        ...
        <form id="searchUserForm">
            <table>
                <tr>
                    ...
                    <td>                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-magnifying-glass',plain:true" onclick="searchUserFun();">查询</a></td>
                     <!--  <th>创建时间:</th>
                    <td>
...
<div id="userToolbar" style="display: none;">
	<shiro:hasPermission name="/pages/systemManager/userAdd.jsp">
