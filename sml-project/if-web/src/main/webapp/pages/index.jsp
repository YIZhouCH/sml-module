...
<script type="text/javascript">
    ...
    $(function() {
        ...
        indexMenuZTree = $.fn.zTree.init($("#layout_west_tree"), {
            ...
            async: {
                enable: true,
                url:smlManager.getQryUrl('system-resource-qry?NOWRAPPER=true&resource_type=0&user_name=<shiro:principal></shiro:principal>'),
            ...
            callback: {
                onClick: function(event, treeId, node) {
                    ...
                    if (url&&url!=''&&url.indexOf("http") == -1) {
                        url = smlManager.metaInfo.baseUrl+url.substring(1,url.length);
                    }
                    if (node.open_mode == 'iframe') {
    ...
    function logout(){
        $.messager.confirm('提示','确定要退出?',function(r){
            if (r){
                progressLoad();
                smlManager.post('',{},function(result){	 
               		 	 progressClose();
                },'sml/security/logout',false);
                location.reload();
            }
        });
    ...
    function editUserPwd() {
        parent.$.modalDialog({
            ...
            width : 300,
            height : 250,
            href : '${ctxPath}/pages/systemManager/userEditPwd.jsp',
            buttons : [ {
                text : '确定',
                handler : function() {
...
<%--         <img src="${ctxPath}/static/style/images/ajax-loader.gif" style="position: absolute;top: 0;left: 0;right: 0;bottom: 0;margin: auto;"/>
 --%>    </div>
    <div id="index_layout">
        <div data-options="region:'north',border:false" style="overflow: hidden;">
            <div>
                <span style="float: right; padding-right: 20px; margin-top: 15px; color: #333">
                    ...
                    <shiro:hasPermission name="/pages/systemManager/userEditPwd.jsp">
