...
<link rel="stylesheet" type="text/css" href="${ctxPath}/static/style/css/icons-view.css" />
<script type="text/javascript" src="${ctxPath}/static/clipboard/clipboard.min.js" charset="utf-8"></script>
<div class="container">
