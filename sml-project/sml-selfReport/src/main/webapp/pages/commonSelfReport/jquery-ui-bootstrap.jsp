...
<%-- <link rel="stylesheet" type="text/css" href="${jquery_ui_bootstrap}/third-party/jQuery-UI-Date-Range-Picker/css/ui.daterangepicker.css"></link>
<script src="${jquery_ui_bootstrap}/third-party/jQuery-UI-Date-Range-Picker/js/date.js" type="text/javascript"></script>
<script src="${jquery_ui_bootstrap}/third-party/jQuery-UI-Date-Range-Picker/js/daterangepicker.jQuery.compressed.js" type="text/javascript"></script>
 --%>
<!-- bootstrap-paginator -->
...
<link rel="stylesheet" type="text/css" href="${jquery_ui_bootstrap}/third-party/jqGrid/css/jqGrid.overrides.css"></link>
<script src="${jquery_ui_bootstrap}/third-party/jqGrid/js/i18n/grid.locale-cn.js" type="text/javascript"></script>
<%-- <script src="${jquery_ui_bootstrap}/third-party/jqGrid/js/jqGrid.common.js" type="text/javascript"></script> --%>
