...
<!-- <script src="${ctx}/scripts/reportManageSys/jquery.fixedheadertable.min.js" type="text/javascript"></script> -->
<!-- <script src="${ctx}/scripts/reportManageSys/jquery.scrollTableBody-1.0.0.js" type="text/javascript"></script> -->
<script src="${ctx}/scripts/reportManageSys/commonAjax.js" type="text/javascript"></script>
<script src="${ctx}/scripts/reportManageSys/publicReport.js" type="text/javascript"></script>
...
<%@ include file="aBackGround.jsp" %>
  ...
  var contextPath = "${ctx}";
	  	$(document).ready(function(){
             ...
             //document.getElementById("cententDiv").style.height = h +"px";
      ...
      window.onload = function ()
          {
              var table = document.getElementById ('otherCondition');
  ...
  <style type="text/css">  
      ...
      #multiSelCondition table{border: solid 1px #D5D5D5;border-collapse: collapse;width: 100%;}
      #multiSelCondition table td{border: 1px solid #D5D5D5;font-size: 14px;padding: 7px 5px;}
      #multiSelCondition table th{background-color: #EEE;border-right: 1px solid #D5D5D5;font-size: 16px;line-height: 120%;font-weight: bold;padding: 8px 5px;text-align: left;}
     
  </style>    
</head>

   
<body onload="" style="overflow-x: auto; overflow-y: auto;min-width:900px">
<div id="curr_id_div" style="display: none"></div>         
               <div id="cententDiv" style="border: 0px solid pink;position: absolute; ">
               	  <div style="border: 0px solid #e8e8e8">
       	        	  	      	...
       	        	  	      	<div id="lianxuDiv" style="margin-top: 0px; display: none;">
                                  <div style="border: 0px solid #e8e8e8 ;padding-bottom: 5px; ">
                                      <div style="margin-bottom: 14px;border-bottom: 1px solid #e8e8e8 ;">
                                             <div id="lianxu_timetype" class="line7890" style="display: inline-block;margin-bottom: 10px;padding: 5px; "> 
                                             ...
                                             <div style="display: inline-block;">
                                                  <input type="button" class="btn btn-primary"  onclick="publicReport.query()" value="查   询"  style="margin-right: 20px;padding:3px 14px;height:34px; color:#fff ; "/>   
                                             </div>
                                       </div>
       	        	  	      	...
       	        	  	      	<div id="lisanDiv" style="margin-top: 0px ; height: 340px; display: none;">
                                       <div style="border: 0px solid #e8e8e8 ; ">
                                          <div style="border-bottom: 1px solid #e8e8e8 ;padding-bottom: 5px;">
                                               <div id="lisan_timetype" class="line7890" style="display: inline-block;margin-bottom: 10px;padding: 5px; "> 
                                                    <input name="timeType2" type="radio" class="RadioStyle" id="Qmin" value="min" style="margin-left: 0px; margin-right: 5px; display: none;"  onclick="showLisanTime.changeTimeType()" /><span id="label_Qmin" style="display: none; margin-right: 20px" >5分钟</span>
                                                    <input name="timeType2" type="radio" class="RadioStyle" id="Q15min" value="15min" style="margin-left: 0px; margin-right: 5px; display: none;"  onclick="showLisanTime.changeTimeType()" /><span id="label_Q15min" style="display: none; margin-right: 20px" >15分钟</span>
                                                    <input name="timeType2" type="radio" class="RadioStyle" id="Q30min" value="30min" style="margin-left: 0px; margin-right: 5px; display: none;"  onclick="showLisanTime.changeTimeType()" /><span id="label_Q30min" style="display: none; margin-right: 20px" >30分钟</span>
                                                   <input name="timeType2" type="radio" class="RadioStyle" id="Qhour" value="hour" style="margin-left: 0px; margin-right: 5px; display: none;"  onclick="showLisanTime.changeTimeType()" /><span id="label_Qhour" style="display: none; margin-right: 20px" >小时</span>

                                                   <input name="timeType2" type="radio" class="RadioStyle" id="Qday" value="day" style="margin-left: 0px;margin-right: 5px; display: none;"  onclick="showLisanTime.changeTimeType()"  checked="checked"/><span id="label_Qday" style="display: none;margin-right: 20px">日</span>
                                                   
                                                     <input name="timeType2" type="radio" class="RadioStyle" id="Qweek" value="week" style="margin-left: 0px; margin-right: 5px; display: none;"  onclick="showLisanTime.changeTimeType()" /><span id="label_Qweek" style="display: none;margin-right: 20px" >周</span>
                                                   
                                                    <input name="timeType2" type="radio" class="RadioStyle" id="Qmonth" value="month" style="margin-left: 0px; margin-right: 5px; display: none;" onclick="showLisanTime.changeTimeType()" /><span id="label_Qmonth" style="margin-right: 20px; display: none;margin-right: 20px">月</span>   
                                               </div>
                                               <div style="display: inline-block;">
                                                    <input type="button" class="btn btn-primary"  onclick="publicReport.query()" value="查   询"  style="margin-right: 20px;padding:3px 14px;height:34px; color:#fff ; "/>   
                                               </div>
                                           ...
                                           <div style="padding-top: 10px;height: 290px">
                                               ...
                                               <!--月模块-->
                                               <div id="monthDiv" class="line7890" style="float: left; width: 90px; height: 275px; border: 1px solid #99bbe8;margin-right: 5px">
                                                   <ul id="monthUl">
                                                       <li><input type="checkbox" name="month" values="00" value="01" onclick="showLisanTime.isShow30or31()" />1月</li>
                                                       <li><input type="checkbox" name="month" values="01" value="02" onclick="showLisanTime.isShow30or31()" />2月</li>
                                                       <li><input type="checkbox" name="month" values="02" value="03" onclick="showLisanTime.isShow30or31()" />3月</li>
                                                       <li><input type="checkbox" name="month" values="03" value="04" onclick="showLisanTime.isShow30or31()" />4月</li>
                                                       <li><input type="checkbox" name="month" values="04" value="05" onclick="showLisanTime.isShow30or31()" />5月</li>
                                                       <li><input type="checkbox" name="month" values="05" value="06" onclick="showLisanTime.isShow30or31()" />6月</li>
                                                       <li><input type="checkbox" name="month" values="06" value="07" onclick="showLisanTime.isShow30or31()" />7月</li>
                                                       <li><input type="checkbox" name="month" values="07" value="08" onclick="showLisanTime.isShow30or31()" />8月</li>
                                                       <li><input type="checkbox" name="month" values="08" value="09" onclick="showLisanTime.isShow30or31()" />9月</li>
                                                       <li><input type="checkbox" name="month" values="09" value="10" onclick="showLisanTime.isShow30or31()" />10月</li>
                                                       <li><input type="checkbox" name="month" values="10" value="11" onclick="showLisanTime.isShow30or31()" />11月</li>
                                                       <li><input type="checkbox" name="month" values="11" value="12" onclick="showLisanTime.isShow30or31()" />12月</li>
                                                   </ul> 
                                               </div>
                                               <!--日模块-->
                                               <div id="dayDiv" class="line7890" style="float: left; width: 110px; height: 275px;border: 1px solid #99bbe8;margin-right: 5px">
                                                    ...
                                                    <div style="height: 248px;overflow:auto; margin-left: 15px">
                                                        <ul id="dayUl">
                                                            ...
                                                            <li id="_29"><input type="checkbox" name="day" value="29"/>29日</li>
                                                            <li id="_30"><input type="checkbox" name="day" value="30"/>30日</li>
                                                            <li id="_31"><input type="checkbox" name="day" value="31"/>31日</li>
                                                        </ul> 
                                                    </div>
                                               </div>
                                               <!--小时模块-->
                                               <div id="hourDiv" class="line7890" style="float: left; width: 110px; height: 275px;border: 1px solid #99bbe8;margin-right: 5px;display: none">
                                               ...
                                               <!--分钟模块-->
                                               <div id="minDiv" class="line7890" style="float: left; width: 110px; height: 275px;border: 1px solid #99bbe8;margin-right: 5px">
                                                    <div style="height: 25px ;"><input type="checkbox" id="minAll" onchange="showLisanTime.minAll()" />全选</div>
                                                    <div style="height: 248px;overflow:auto; margin-left: 15px">
                                                        <ul id="minUl">
                                               ...
                                               <!--周模块-->
                                               <div id="weekDiv" class="line7890" style="display: none; float: left; width: 370px; height: 275px; border: 1px solid #99bbe8;margin-right: 5px;overflow:auto">
                                                   <ul id="weekUl">
                                               ...
                                               <!--结果模块-->
                                               <div class="line7890" style="float: left; min-width: 200px;height:275px;border: 1px solid #99bbe8;margin-right: 5px;overflow:hidden;">
               	  ...
               	  <div id="otherConWai" style="border: 1px solid #e8e8e8 ; margin-top: 20px;padding: 20px 20px; position: relative; display: none">
                          ...
                          <!-- <div id="queryDetailedInfos" style="margin-top: 10px; display: none; border: 1px solid #99bbe8 ; height: 300px; overflow-y: auto;">
                                fddsfdsdf
                          </div> -->
           	  	  ...
           	  	  <div id="baocunDiv" style="padding: 10px 20px 0 0; position: relative;height: 75px; margin-top: 12px;border-top: 1px solid #e8e8e8;">
                     ...
                     <input type="button" class="btn btn-primary"  onclick="publicReport.query()" value="查   询"  style="margin-right: 20px;padding:3px 14px;height:34px; color:#fff ;float:left; "/>  
...
<!-- ------------------------------------------------------------------------------ -->
 <div id="mm1"   style="width:100px;height:60px;display:none;z-index:999;position:absolute; border:1px solid #CCC;">
    <div >新建目录</div>
    <div >新建报表</div>
    <div >修改目录</div>
    <div >删除目录</div>
